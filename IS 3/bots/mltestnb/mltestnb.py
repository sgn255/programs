...
def features(state):
    ...
    hand = sum(state.hand())+0.01
    feature_set.append(hand)

    point_diff1 = util.difference_points(state, 1)
    feature_set.append(point_diff1)

    point_diff2 = util.difference_points(state, 2)^2
    feature_set.append(point_diff2)
