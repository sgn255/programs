...
public class ExampleEnvironment extends EnvironmentDescription {
	public ExampleEnvironment() {
        ...
        Wall roomWall7 = new Wall(new Vector3d(-6, 0, 8), 4, 1, this);
        roomWall7.setColor(new Color3f(Color.BLUE));
        add(roomWall7);
        
        Wall roomWall8 = new Wall(new Vector3d(-6, 0, -6), 4, 1, this);
        roomWall8.setColor(new Color3f(Color.BLUE));
        add(roomWall8);
        
        Box box1 = new Box(new Vector3d(4, 0, -8), new Vector3f(1, 1, 1), this);
